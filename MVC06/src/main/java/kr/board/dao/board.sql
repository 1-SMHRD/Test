...
insert into board(idx,title, content, writer)
values(idx_seq.nextval,'게시판연습2','게시판연습2','박매일');

insert into board(idx,title, content, writer)
values(idx_seq.nextval,'게시판연습3','게시판연습3','임보미');
...
insert into memtbl values('smhrd02','smhrd02','박매일');
insert into memtbl values('smhrd03','smhrd03','임보미');
